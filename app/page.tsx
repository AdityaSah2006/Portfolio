        ...
        <div className="max-w-7xl mx-auto px-8 py-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-12 items-center">
            ...
            <div className="flex gap-4 ml-4">
              ...
              <a href="https://github.com/AdityaSah2006" className="text-gray-700 hover:text-gray-900 transition">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div>
            ...
            <h1 className="text-7xl md:text-7xl font-bold mb-5 leading-tight">
...
>
  Download CV
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 transform rotate-0scale-95">
              <div className="w-ful h-[500px] bg-gradient-to-br from-amber-400 to-rose-400 rounded-3xl shadow-2xl"></div>
            </div>
            <div className="absolute inset-6 transform -rotate-0 scale-97">
              <div className="w-full h-[450px] bg-gradient-to-br from-blue-10 to-blue-800 rounded-3xl shadow-2xl"></div>
            </div>
            ...
            <div className="relative bg-purplr rounded-3xl shadow-2xl overflow-hidden p-10">
              <div className="bg-gradient-to-br from-white-00 to-rose-00 rounded-2xl h-[500px] flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center">
                  <div className="w-64 h-64 rounded-full mb-10 mx-auto overflow-hidden border-3 border- shadow-2xl">
                    <img 
                      src="/profile.jpg" 
                      alt="Aditya Sah" 
                ...
                {/* Decorative elements */}
                <div className="absolute top-4 right-4 w-15 h-15 bg-white/50 rounded-full blur-xl"></div>
